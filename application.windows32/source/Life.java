...
private void draw_menu_animation(int x, int y, boolean first){
  ...
  matrix_img = update_matrix_img();
  matrix_img = image_manager.gaussian_filter(matrix_img,0.45f,5);
  matrix_img = image_manager.pixel_scaler(matrix_img,10);
  matrix_img = image_manager.gaussian_filter(matrix_img,1.5f,5);
...
class data_manager{
  ...
  public void m_save(int[][] m, String name){
...
class image_manager{
  ...
  public PImage pixel_scaler(PImage img, int scale){
  ...
  public PImage gaussian_filter(PImage original, float sigma, int size){
  ...
  public float[] create_gaussian(float sigma, int size){
...
*/
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "Life" };
    if (passedArgs != null) {
