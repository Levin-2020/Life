...
private void draw_menu(){
  ...
  //buttons
  //build
  button_manager.draw_button("Build", button_loc[0], button_size[0]);
  //watch
  button_manager.draw_button("Watch", button_loc[1], button_size[1]);
  //info
  button_manager.draw_button("Info", button_loc[2], button_size[2]);
  //exit
  button_manager.draw_button("Exit", button_loc[3], button_size[3]);
}
...
private void draw_menu_animation(int x, int y, boolean first){
  ...
  matrix = data_manager.m_load("main_menu4.json");
